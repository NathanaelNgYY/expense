...
- The boundary now reports through the Sentry integration. Remote delivery remains disabled until the owner supplies a Sentry project DSN; see `docs/testing/sentry-monitoring.tdd.md`.
