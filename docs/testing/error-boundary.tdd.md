...
- External monitoring is not connected yet. The optional `onError` callback is ready for Sentry, but completing that phase requires a Sentry project/DSN and a deliberate dependency/configuration change.
